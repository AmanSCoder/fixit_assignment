...
class DocumentProcessor:
    ...
    def chunk_text(self, text: str) -> List[str]:
        ...
        while start_idx < len(text):
            ...
            if end_idx < len(text):
                ...
                if paragraph_end != -1 and paragraph_end > start_idx + self.chunk_size // 2:
                    ...
                    for marker in sentence_end_markers:
                        ...
                        if sentence_end != -1 and sentence_end > start_idx + self.chunk_size // 2:
    ...
    def process_document(self, document_id: str, object_name: str) -> Tuple[List[str], List[Dict]]:
